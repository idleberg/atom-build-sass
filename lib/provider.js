...
export function provideBuilder() {
  return class SassProvider extends EventEmitter {
    ...
    settings() {
      ...
      // User settings
      let customSassArguments = atom.config.get('build-sass.customSassArguments').trim().split(" ");
      customSassArguments.push('{FILE_ACTIVE}');
      customSassArguments.push('{FILE_ACTIVE_NAME_BASE}.css');

      let customScssArguments = atom.config.get('build-sass.customScssArguments').trim().split(" ");
